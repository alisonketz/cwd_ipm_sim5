...
nimConsts <- list(
    ...
    nknots_age_fawn = nknots_age_fawn,
...
initsFun <- function()list(
    ...
    tau_age_survival = runif(1, .1, 1),
     ln_b_age_survival_fawn = rnorm(nknots_age_fawn) * 10^-4,
    tau_age_survival_fawn = runif(1, .1, 1),
    mix_survival = 1,
